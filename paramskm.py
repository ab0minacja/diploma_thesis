...
def test_kmeans_with_different_centroids(X_scaled):
    ...
    n_clusters_range = range(2, 20)  # Testujemy liczby klastrów od 2 do 10
    results = []
    ...
    # Porównanie wyników różnych metod inicjalizacji
...
# Przygotowanie danych (zakładając, że X_scaled jest już przygotowane)
# Zakomentowane poniżej — w twoim środowisku zamień na odpowiednie dane
# X_scaled = scaler.fit_transform(X)
...
def evaluate_n_clusters(X_scaled):
    ...
    # Wykresy metryk w zależności od liczby klastrów
